...
The pipeline has a bats-core test suite with **286 tests across 22 test files** in `~/development/pilot/tests/`. Tests use two-tier execution to balance speed with thoroughness:

**Fast tier (279 tests) — pre-commit hook:**
...
**Full tier (286 tests) — GitHub Actions CI:**
...
| `~/development/pilot/tests/` | bats-core test suite (286 tests, 22 files, two-tier execution) |
