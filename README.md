...
The pipeline includes a **test suite** (376 bats tests, two-tier execution, pre-commit hook) to validate adapter contracts and pipeline logic before any code ships.
